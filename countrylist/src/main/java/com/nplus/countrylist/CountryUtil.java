...
//            String LatestCountrycode = countryRegion == null ? ContryCode : ((countryRegion.isEmpty()) ? ContryCode : countryRegion);
        ...
        protected void onPostExecute(ArrayList<Country> data) {
            ...
            if (mSpinnerPosition > 0) {
                ...
                mPhoneEdit.setText(data.get(mSpinnerPosition).getCountryCode() + "");
                if (listener != null && mPhoneEdit != null)
                    listener.onCountryCodeChanged(mPhoneEdit.getText().toString(), LatestCountrycode);
            }
        }
    }
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (listener != null && mPhoneEdit != null && c != null) {
                    ...
                    listener.onCountryCodeChanged(mPhoneEdit.getText().toString(), c.getCountryISO());
                }
