...
import bz.pei.driver.ui.SignupScreen.TermsandCons;
...
/**/
public class SignupFragment extends BaseFragment<FragmentSignupBinding, SignupFragmentViewModel> implements SignupFragmentNavigator, CountryCodeChangeListener {
...
//                startActivity(new Intent(getActivity(), TermsandCons.class));
    ...
    public void setCurrentCountryCode(String countryCode) {
        ...
        mCountryUtil.initUI(fragmentMapBinding.editCountryCodeSignup, this, fragmentMapBinding.imgFlagSignup);
